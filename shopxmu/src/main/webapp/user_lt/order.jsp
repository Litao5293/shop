...
<html>
	...
	<head>
		...
		<link href="../user_lt/css/orstyle.css" rel="stylesheet" type="text/css">

		<script src="../user_lt/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
													...
													<div class="order-left">
															...
															<li class="td td-item">
																<div class="item-pic">
																	<a href="#" class="J_MakePoint">
																		<img src="../user_lt/images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
														...
														<ul class="item-list">
															<li class="td td-item">
																<div class="item-pic">
																	<a href="#" class="J_MakePoint">
																		<img src="../user_lt/images/62988.jpg_80x80.jpg" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
																	<div class="item-basic-info">
